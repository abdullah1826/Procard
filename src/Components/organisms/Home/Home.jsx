...
const Home = () => {
  ...
  let [iStyle, setiStyle] = useState("style2");
  // useEffect(() => {
    ...
    get(child(dbRef, `User/${userid}`))
      .then((snapshot) => {
        if (snapshot.exists()) {
          ...
          setiStyle(snapshot.val()?.IconStyle);
        } else {
          ...
          {iStyle === "style1" ? (
            ...
            <div
              style={{
                ...
                borderRadius: iStyle === "style2" ? "6px" : "100%",
                display: "flex",
                justifyContent: "center",
                alignItems: "center",
              }}
            >
              {returnIcons(id?.name, 22)}
            </div>
          )}
      ...
      >
        ...
        >
          <div className="profile_pc_main">
            <div
              ...
              style={{
                border: !loginUserData?.profileUrl ? "" : "2px solid black",
              }}
            >
              {profileurl ? (
                <img
          ...
          <div
            className="a3_title_div"
            style={{ color: theme === "theme1" ? "black" : "white" }}
          >
            {loginUserData?.name}
          </div>
          <div
            className="a3_sub_title_div"
            style={{ color: theme === "theme1" ? "black" : "white" }}
          >
            {loginUserData?.username}
          </div>
          <div
            className="email_main_div"
            style={{ color: theme === "theme1" ? "black" : "white" }}
          >
            {loginUserData?.email}
          </div>
        ...
        {Opendrawer && (
          <div className="sideDrawer_main_div">
            <Drawer hideDrawer={() => setShowDrawer(false)} theme={theme} />
          </div>
        )}
      </div>
    </div>
